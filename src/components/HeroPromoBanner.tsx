...
const HeroPromoBanner = ({ className = "" }: HeroPromoBannerProps) => {
  return (
    ...
    >
      <div className="pointer-events-auto inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-white border-2 border-white px-3 sm:px-4 py-1.5 shadow-md">
        <span className="font-black text-[10px] sm:text-xs text-primary uppercase tracking-wide">
          <strong>Versandkostenfreier Versand</strong>
        </span>

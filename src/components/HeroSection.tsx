...
const HeroSection = () => {
  return (
    <section className="relative overflow-visible flex justify-center">
      {/* Fixed-size inner wrapper so layout never changes on desktop */}
      <div
        className="relative w-full lg:w-[1800px] lg:min-h-[1296px] bg-cover bg-top overflow-visible"
        style={{ backgroundImage: `url(${heroBg})` }}
      >
        <div className="relative z-10 px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 md:pt-36 lg:pt-40 xl:pt-48 pb-4 sm:pb-0 max-w-[1800px] mx-auto">
          <div className="flex flex-col lg:flex-row lg:items-end">
            ...
            >
              <img
                ...
                className="w-[115%] sm:w-[98%] md:w-[80%] lg:w-[62%] h-auto lg:-translate-y-72 lg:translate-x-[20%] animate-[breathe_3s_ease-in-out_infinite]"
              />
            </motion.div>
          </div>
        </div>

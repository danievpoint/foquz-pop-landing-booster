...
const HeroSection = () => {
  return (
    <section
      className="relative overflow-visible bg-cover bg-top"
      style={{ backgroundImage: `url(${heroBg})`, minHeight: 'max(700px, 75vh)' }}
    >
      <div className="relative z-10 w-full max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 md:pt-36 lg:pt-40 pb-4 sm:pb-0">
        <div className="flex flex-col lg:flex-row lg:items-start">
          ...
          <motion.div
            ...
            className="lg:w-[60%] xl:w-[64%] flex items-end justify-center lg:justify-center lg:-mt-[15%]"
          >
            <img
              src={heroJars}

...
const HeroSection = () => {
  return (
    <section
      className="relative overflow-visible bg-cover bg-top lg:min-h-[1296px]"
      style={{ backgroundImage: `url(${heroBg})` }}
    >
      {/* Fixed-width inner wrapper so content stays positioned consistently */}
      <div className="relative z-10 w-full max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 md:pt-36 lg:pt-40 xl:pt-48 pb-4 sm:pb-0">

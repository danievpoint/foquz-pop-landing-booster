...
const HeroSection = () => {
  return (
    <section className="relative overflow-visible">
      {/* Background SVG as img so it scales consistently across all viewports */}
      <div className="relative w-full" style={{ minHeight: 'max(700px, 75vh)' }}>
        <img
          src={heroBg}
          alt=""
          aria-hidden="true"
        ...
        {/* Product image – positioned relative to the bg image */}
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.3 }}
          className="hidden lg:block absolute z-20"
          style={{ top: '8%', left: '52%', width: '27%' }}
        >
          <img
            src={heroJars}
        ...
        {/* Text content */}
        <div className="relative z-10 w-full max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 md:pt-36 lg:pt-40 pb-4 sm:pb-0">

  ...
  return (
    <footer className="bg-background pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-[3fr_1fr_1fr_1fr_1fr] gap-8 md:gap-6 mb-10">
          {/* Logo & Claim + Social */}
          <div className="col-span-2 md:col-span-1">
            <img src={foquzLogo} alt="FOQUZ" className="h-20 mb-3 -ml-2" />
            <p className="text-base md:text-lg opacity-80 mb-1 font-bold">
          ...
          {/* Shop */}
          <div>
            <h4 className="text-base font-extrabold mb-4">SHOP</h4>
          ...
          {/* Info */}
          <div>
            <h4 className="text-base font-extrabold mb-4">INFO</h4>
            <ul className="space-y-2 text-sm opacity-80">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-base font-extrabold mb-4">LEGAL</h4>
            <ul className="space-y-2 text-sm opacity-80">
          ...
          <div className="flex flex-col">
            <h4 className="text-base font-extrabold mb-4">HILFE</h4>
            ...
            <div className="flex gap-2 mt-auto pt-4 flex-nowrap">
              {["PayPal", "Klarna", "VISA"].map((method) => (
                <div
                  key={method}
                  className="bg-foreground/10 border border-foreground/20 rounded-md px-3 py-1.5 text-xs font-bold select-none"
                >
                  {method}
                </div>
              ))}
        ...
        <div className="border-t border-foreground/20 pt-6 text-center text-xs opacity-60">

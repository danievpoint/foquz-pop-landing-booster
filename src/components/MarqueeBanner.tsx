...
const MarqueeBanner = () => {
  ...
  return (
    <section className="fixed top-0 left-0 right-0 z-[10000] bg-secondary overflow-hidden border-b border-foreground/30 h-[28px] md:h-[32px] flex items-center" data-banner>
